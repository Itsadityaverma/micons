...
const Teams = () => {
    ...
    return (
        <div id="our-teams">
            <div className="team-wrap text-center bg-white">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-3">
                            <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={collabOne} alt="collaborationImage" />
                            <h3 className="icon-title">Anecs Design</h3>
                        </div>
                        <div className="col-12 col-md-3">
                            <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={collabTwo} alt="collaborationImage" />
                            <h3 className="icon-title">KRIEA Design</h3>
                        </div>
                        <div className="col-12 col-md-3">
                            <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={collabThree} alt="collaborationImage" />
                            <h3 className="icon-title">Arira Build tech Pvt Ltd</h3>
                        </div>
                        <div className="col-12 col-md-3">
                            <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={collabFour} alt="collaborationImage" />
                            <h3 className="icon-title">Reality Studios</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div className="affil-wrap text-center bg-white">
                <div className=" sec-space">
                    <div className="container">
                        <h1 className="heading-title"> affiliations</h1>
                        <div className="row">
                            <div className="col-12 col-md-4">
                                <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={affilOne} alt="affiliationsImage" />
                                <h3 className="icon-title">Haridwar Roorkee DevelopmentAuthority (HRDA)</h3>
                            </div>
                            <div className="col-12 col-md-4">
                                <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={affilTwo} alt="affiliationsImage" />
                                <h3 className="icon-title">NagamNigam, Haridwar</h3>
                            </div>
                            <div className="col-12 col-md-4">
                                <img className="icons" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="500" src={affilThree} alt="affiliationsImage" />
